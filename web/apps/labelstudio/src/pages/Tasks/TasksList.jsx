...
export const TasksList = ({ projects, currentPage, totalItems, loadNextPage, pageSize }) => {
  return (
    <>
      <Elem name="list">
...
export const EmptyTasksList = ({ openModal }) => {
  return (
...
const ProjectCard = ({ project }) => {
  ...
  return (
    <Elem tag={NavLink} name="link" to={`/tasks/${project.id}/data`} data-external>
          ...
          <Elem name="title">
            ...
            >
              <Dropdown.Trigger
                content={
                  <Menu contextual>
                    <Menu.Item href={`/tasks/${project.id}/settings`}>Settings</Menu.Item>
                    <Menu.Item href={`/tasks/${project.id}/data?labeling=1`}>Label</Menu.Item>
                  </Menu>
                }
              >
